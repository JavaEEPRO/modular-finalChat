...
import si.inspirited.ejb.CalendarCounter;
...
public class MainManager implements Serializable{
    ...
    private String color;  //доделать
    private String uname;

    private boolean loginSuccess;
    private boolean createSuccess;
    private boolean pickedSuccess;  // доделать
    ...
    public List<Line> getCalendar() {return calendarCounter.getCalendar();}
